    ...
    <div class="bg-white p-6 rounded-xl shadow-lg">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <input type="date" id="filter-tanggal-awal"
                    class="border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500" placeholder="Dari">
        ...
        <div class="overflow-x-auto">
            <table id="peminjamanTable" class="w-full border-collapse">
                <thead>
                    <tr class="bg-gray-50">
                        <th class="p-3 border-b text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No
                        </th>
                        <th class="p-3 border-b text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Peminjam</th>
                        <th class="p-3 border-b text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Petugas</th>
                        <th class="p-3 border-b text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Alat
                            Dipinjam</th>
                        <th class="p-3 border-b text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Tanggal</th>
                        <th class="p-3 border-b text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status
                        </th>
                        <th class="p-3 border-b text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Aksi
                        </th>
                    </tr>
                </thead>
                                ...
                                <div class="max-w-xs">
                                    @foreach ($p->detailPeminjaman as $d)
                                        <div class="flex justify-between items-center mb-1 last:mb-0">
                                            <span
                                                class="text-sm">{{ $d->alat->nama_alat ?? 'Alat tidak ditemukan' }}</span>
                                    ...
                                    @if ($p->detailPeminjaman->count() > 2)
                                        <button type="button" onclick="showDetailAlat({{ $p->id_peminjaman }})"
        ...
        $(document).ready(function() {
            ...
            var table = $('#peminjamanTable').DataTable({
                ...
                buttons: [{
                        ...
                        className: 'inline-flex items-center px-4 py-2 rounded-lg bg-green-600 text-white text-sm font-medium ' +
                    ...
                    },
                    {
                        ...
                        className: 'inline-flex items-center px-4 py-2 rounded-lg bg-red-600 text-white text-sm font-medium ' +
