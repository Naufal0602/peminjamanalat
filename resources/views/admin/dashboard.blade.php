...
@section('content')
    <div class="p-6">
                    ...
                    <div class="bg-blue-50 p-3 rounded-full">
                        <svg class="w-8 h-8 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 3.75V21m-4.5-4.5H21">
                            </path>
                        </svg>
                    </div>
                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-800">
                                            {{ $peminjaman->peminjam->name ?? 'Tidak diketahui' }}</p>
                            ...
                            <div class="flex items-start p-3 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">
                                        {{ \Carbon\Carbon::parse($log->waktu)->translatedFormat('d M Y, H:i') }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow mt-6">
            <h2 class="text-lg font-bold mb-4">Statistik Peminjaman</h2>
