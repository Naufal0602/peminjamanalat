<div class="bg-[#050706] text-white w-64 flex flex-col">
    <div class="p-4 flex items-center border-b border-gray-700">
        ...
        <div class="flex-row">
            <h1 class="text-xl font-bold text-center">Sistem</h1>
    ...
    <nav class="flex-1 py-4">
        <ul class="space-y-1 px-3">
            ...
            <li>
                <a href="{{ route('admin.alat.index') }}" class="flex items-center p-3 rounded-lg hover:bg-gray-800">
                    <i class="fa-solid fa-tools mr-3"></i> Alat
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('admin.log_aktivitas.index') }}"
                    class="flex items-center p-3 rounded-lg hover:bg-gray-800">
                    <i class="fa-solid fa-clock-rotate-left mr-3"></i> log aktivitas
                </a>
            </li>
            <li>
                <a href="{{ route('profile.edit') }}" class="flex items-center p-3 rounded-lg hover:bg-gray-800">
                    <i class="fa-solid fa-user mr-3"></i> Profil
                </a>
            </li>
            <li>
                <a href="{{ route('admin.peminjaman.index') }}"
                    class="flex items-center p-3 rounded-lg hover:bg-gray-800">
                    <i class="fa-solid fa-handshake mr-3"></i> Peminjaman
                </a>
            </li>
        </ul>
    </nav>
